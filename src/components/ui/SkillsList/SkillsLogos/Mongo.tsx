...
export default function MongoDBLogo ({ isActive, inactiveColor, className, ...props }: LogosProps) {
  return (
    <svg
    ...
    >
      <path
        fill={`${isActive ? '#599636' : inactiveColor}`}
      ...
      />
      <path
        fill={`${isActive ? '#6cac48' : inactiveColor}`}
        className="transition-all"
      ...
      />
      <path
        fill={`${isActive ? '#c2bfbf' : inactiveColor}`}
        className="transition-all"
